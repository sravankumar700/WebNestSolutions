...
export const sendNewsletterWelcomeEmail = (email: string) =>
  transporter.sendMail({
    ...
    text: 'Thanks for subscribing to the WebNest Solutions newsletter. Use offer code WEB on your next website quotation to receive 10% off the project price. We will also keep you updated with new projects, insights, and useful web tips.',
