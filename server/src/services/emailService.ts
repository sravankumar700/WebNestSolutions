...
export const verifyEmailTransport = async () => {
  ...
  console.info(`[Email] SMTP connection verified via ${process.env.SMTP_HOST}:${process.env.SMTP_PORT || 587}.`);
};
...
export const sendNewsletterWelcomeEmail = (email: string) =>
  transporter.sendMail({
    ...
    text: 'Thanks for subscribing to the WebNest Solutions newsletter. Use offer code WEB10 on your next website quotation to receive 10% off the project price. We will also keep you updated with new projects, insights, and useful web tips.',
